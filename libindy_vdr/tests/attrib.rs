...
mod builder {
    ...
    mod attrib {
        ...
        #[rstest]
        fn test_pool_build_attrib_requests_works_for_raw_value(request_builder: RequestBuilder,
        ...
        #[rstest]
        fn test_pool_build_attrib_requests_works_for_hash_value(request_builder: RequestBuilder,
                                                                trustee_did: DidValue,
                                                                my_did: DidValue) {
            let attrib_request =
                request_builder
        ...
        #[rstest]
        fn test_pool_build_attrib_requests_works_for_enc_value(request_builder: RequestBuilder,
                                                               trustee_did: DidValue,
                                                               my_did: DidValue) {
            let attrib_request =
                request_builder
        ...
        #[rstest]
        fn test_pool_build_attrib_requests_works_for_fully_qualified_dids(request_builder: RequestBuilder,
                                                                          trustee_did: DidValue,
                                                                          my_did: DidValue) {
            let attrib_request =
                request_builder
    ...
    mod get_attrib {
        ...
        #[rstest]
        fn test_pool_build_get_attrib_requests_works_for_raw_value(request_builder: RequestBuilder,
                                                                   my_did: DidValue) {
            let attrib_request =
                request_builder
                    .build_get_attrib_request(None,
                                              &my_did,
        ...
        #[rstest]
        fn test_pool_build_get_attrib_requests_works_for_hash_value(request_builder: RequestBuilder,
                                                                    my_did: DidValue) {
            let attrib_request =
                request_builder
                    .build_get_attrib_request(None,
        ...
        #[rstest]
        fn test_pool_build_get_attrib_requests_works_for_enc_value(request_builder: RequestBuilder,
                                                                   my_did: DidValue) {
            let attrib_request =
                request_builder
                    .build_get_attrib_request(None,
        ...
        #[rstest]
        fn test_pool_build_get_attrib_requests_works_for_fully_qualified_dids(request_builder: RequestBuilder,
                                                                              fq_my_did: DidValue,
                                                                              my_did: DidValue) {
            let attrib_request =
                request_builder
...
mod send_attrib {
    ...
    fn test_pool_send_attrib_request_for_hash_value(pool: TestPool) {
        ...
        assert_eq!(ATTRIB_HASH_DATA.to_string(), helpers::get_response_data(&response).unwrap());
    }
    ...
    fn test_pool_send_attrib_request_for_enc_value(pool: TestPool) {
        ...
        assert_eq!(ATTRIB_ENC_DATA.to_string(), helpers::get_response_data(&response).unwrap());
    }
    ...
    #[rstest]
    fn test_pool_send_attrib_request_for_unknown_target_identity(pool: TestPool,
                                                                 trustee: Identity,
                                                                 identity: Identity) {
        // Send Attrib
        let mut attrib_request =
    ...
    #[rstest]
    fn test_pool_send_attrib_request_for_unknown_sender(pool: TestPool,
                                                        identity: Identity) {
        // Send Attrib
        let mut attrib_request =
            pool.request_builder()
