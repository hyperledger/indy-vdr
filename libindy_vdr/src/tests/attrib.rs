...
mod builder {
    use super::*;
    use crate::tests::utils::constants::{TRUSTEE_DID, MY1_DID, TRUSTEE_DID_FQ, MY1_DID_FQ};
    ...
    mod attrib {
        ...
        fn test_pool_build_attrib_requests_works_for_raw_value() {
            ...
            let attrib_request =
                pool.request_builder()
                    .build_attrib_request(&DidValue(String::from(TRUSTEE_DID)),
        ...
        fn test_pool_build_attrib_requests_works_for_fully_qualified_dids() {
            ...
            let attrib_request =
                pool.request_builder()
                    .build_attrib_request(&DidValue(String::from(TRUSTEE_DID_FQ)),
