...
/*
/// Set indy-ledger runtime configuration. Can be optionally called to change current params.
///
/// #Params
/// config: {
...
/// Common*
#[no_mangle]
pub extern fn indy_ledger_set_runtime_config(config: *const c_char) -> ErrorCode {
...
///             2) calling `indy_ledger_set_runtime_config` API function with `collect_backtrace: true`
///     "message": str - human-readable error description
/// }
///
#[no_mangle]
pub extern "C" fn indy_ledger_get_current_error(error_json_p: *mut *const c_char) {
    trace!(
