FROM rustembedded/cross:x86_64-linux-android-0.2.1
...
RUN cd libzmq/builds/android && ./build.sh x86_64

ENV PKG_CONFIG_PATH=/tmp/libzmq/builds/android/prefix/x86_64/lib/pkgconfig