import type { SerializedOptions } from '../utils'
import type {
...
export class ReactNativeIndyVdr implements IndyVdr {
  ...
  public async poolSubmitAction(options: PoolSubmitActionOptions & { poolHandle: PoolHandle }): Promise<string> {
    const serializedOptions = serializeArguments(options) as SerializedOptions<typeof options>
  ...
  public async poolSubmitRequest(options: PoolSubmitRequestOptions & { poolHandle: PoolHandle }): Promise<string> {
    const serializedOptions = serializeArguments(options) as SerializedOptions<typeof options>
    // TODO: This is not string
