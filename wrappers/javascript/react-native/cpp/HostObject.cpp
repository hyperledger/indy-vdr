...
FunctionMap TurboModuleHostObject::functionMapping(jsi::Runtime &rt) {
  ...
  // fMap.insert(std::make_tuple("setDefaultLogger",
  // &indyVdr::setDefaultLogger));
  // fMap.insert(std::make_tuple("setProtocolVersion",
  // &indyVdr::setProtocolVersion));
  ...
  // fMap.insert(std::make_tuple("buildCustomRequest",
  // &indyVdr::buildCustomRequest));
  // fMap.insert(std::make_tuple("buildDisableAllTxnAuthorAgreementsRequest",
  // &indyVdr::buildDisableAllTxnAuthorAgreementsRequest));
  // fMap.insert(std::make_tuple("buildGetNymRequest",
  ...
  // fMap.insert(std::make_tuple("buildGetTxnRequest",
  ...
  // fMap.insert(std::make_tuple("buildSchemaRequest",
  ...
  // fMap.insert(std::make_tuple("buildGetRichSchemaObjectByMetadataRequest",
  ...
  // fMap.insert(std::make_tuple("poolGetTransactions",
  // &indyVdr::poolGetTransactions));
  // fMap.insert(std::make_tuple("poolGetVerifiers",
  // &indyVdr::poolGetVerifiers));
  // fMap.insert(std::make_tuple("poolSubmitAction",
  // &indyVdr::poolSubmitAction));
  // fMap.insert(std::make_tuple("poolSubmitRequest",
  // &indyVdr::poolSubmitRequest)); fMap.insert(std::make_tuple("poolClose",
  // &indyVdr::poolClose));

  // fMap.insert(std::make_tuple("requestSetEndorser",
  // &indyVdr::requestSetEndorser));
  // fMap.insert(std::make_tuple("requestSetMultiSignature",
  // &indyVdr::requestSetMultiSignature));
  // fMap.insert(std::make_tuple("requestSetSignature",
  // &indyVdr::requestSetSignature));
  // fMap.insert(std::make_tuple("requestSetTxnAuthorAgreementAcceptance",
  ...
  // fMap.insert(std::make_tuple("request_get_body",
  // &indyVdr::request_get_body));
