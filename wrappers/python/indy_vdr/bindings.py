...
def set_ledger_txn_cache(capacity: int, expiry_offset_ms: int, path: str):
    """Set the library configuration."""
    do_call("indy_vdr_set_ledger_txn_cache", c_size_t(capacity), c_ulong(expiry_offset_ms), encode_str(path))
